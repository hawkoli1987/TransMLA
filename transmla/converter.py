...
def main(args):
    ...
    model = partial_rope(model, tokenizer, train_loader, test_loader, original_model=original_model_for_kl, **vars(args))
    ...
    model = low_rank_qkv(model, tokenizer, train_loader, test_loader, original_model=original_model_for_kl, **vars(args))
